...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype, String meter) {
        ...
        master.setFont(new Font("",Font.BOLD, 24));
        ...
        info.setFont(new Font("",Font.BOLD, 24));
        ...
        report.setFont(new Font("",Font.BOLD, 24));
        ...
        utility.setFont(new Font("",Font.BOLD, 24));
        ...
        mexit.setFont(new Font("",Font.BOLD, 24));
